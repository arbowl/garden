...
async def vote(
    ...
    return templates.TemplateResponse(request, "partials/vote_col.html", {"post": post})
...
async def vote_comment(
    ...
    return templates.TemplateResponse(request, "partials/comment_vote.html", {"comment": comment})
